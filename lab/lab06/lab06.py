...
class Account:
    ...
    def deposit(self, amount):
        ...
        """
        a=Transaction(self.id,self.balance,self.balance+amount)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            a=Transaction(self.id,self.balance,self.balance)
            self.id+=1
            self.transactions.append(a)
...
def make_change(amount, coins):
    ...
    if amount < smallest:
        return None
    "*** YOUR CODE HERE ***"
    new_amount=amount-smallest
    if new_amount==0:
        return [smallest]
    elif new_amount<0:
        return None
    m=make_change(amount,rest)
    n=make_change(new_amount,rest)
    if n!=None:
        return [smallest]+n
    elif m!=None :
        return m
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        if coin in self.coins:
            self.coins[coin]=1+self.coins[coin]
        else:
            self.coins[coin]=1
