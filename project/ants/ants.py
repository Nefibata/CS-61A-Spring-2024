...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        count=0
        a= self.place
        while a.bees==[] or count>up or count <low:
            if a.entrance is not None:
                a=a.entrance
                count+=1
            else:
                break
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        temp_list=list(self.place.bees)
        Ant.reduce_health(self,amount)
        if self.health<=0:
            a=amount+self.damage
        else:
            a=amount
        for i in temp_list:
            i.reduce_health(a)
    ...
    def do_double(self):
        ...
        while a is not None:
            if a.ant is not None:
                if a.ant.is_container:
                    a.ant.double()
                    if a.ant.ant_contained is not None:
